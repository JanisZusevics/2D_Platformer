 ...
 * \brief Header file for the debug
 *
 * A debug toggle shows the fixtures for each body
 * This is an overview of how the debug operate
 */
...
#include <SFML/Graphics.hpp>
 ...
 /*! \class DebugDraw
 \brief A class that controls the Debug Draw
 */
